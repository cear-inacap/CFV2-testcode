...
void setup() {
    ...
    encoder1.attachHalfQuad(EN1B, EN1A); //espejo
    encoder2.attachHalfQuad(EN2A, EN2B);
    encoder3.attachHalfQuad(EN3A, EN3B);
    encoder4.attachHalfQuad(EN4B, EN4A); //espejo
    encoder1.setCount(0);
    encoder2.setCount(0);
    encoder3.setCount(0);
    encoder4.setCount(0);
...
void loop() {
    long newPosition1 = encoder1.getCount() / 2;
    long newPosition2 = encoder2.getCount() / 2;
    long newPosition3 = encoder3.getCount() / 2;
    long newPosition4 = encoder4.getCount() / 2;
    Serial.print(newPosition1);
    Serial.print(" | ");
    Serial.print(newPosition2);
    Serial.print(" | ");
    Serial.print(newPosition3);
    Serial.print(" | ");
