...
void loop() {
    if(millis() > actual_time + 730){
        ...
        switch(secuencia){
          ...
          case 10:   parar();break;
          case 11:   giro_derecha();break;
          case 12:   giro_derecha(); break;
          case 13:   parar();break;
          case 14:   avanzar();break;
          case 15:  giro_derecha();break;
          case 16:  giro_derecha();break;
          case 17:   parar();break;
          case 18:   parar();break;
        }

        if(secuencia > 17) secuencia = 0;
    }
